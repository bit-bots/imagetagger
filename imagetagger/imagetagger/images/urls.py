...
urlpatterns = [
    ...
    url(r'^imageset/create/(\d+)/$', views.create_imageset, name='create_imageset'),
    url(r'^imageset/delete/(\d+)/$', views.delete_imageset, name='delete_imageset'),
    url(r'^imageset/(\d+)/$', views.view_imageset, name='view_imageset'),
    url(r'^imageset/edit/(\d+)/$', views.edit_imageset, name='edit_imageset'),
