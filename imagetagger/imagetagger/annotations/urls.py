...
urlpatterns = [
    ...
    url(r'^api/annotation/create/$', views.api_create_annotation, name='create_annotation'),
    url(r'^api/annotation/delete/$', views.api_delete_annotation, name='delete_annotation'),
    url(r'^api/annotation/load/$', views.api_load_annotations, name='load_annotations'),  # loads annotations of an image
    url(r'^api/annotation/loadset/$', views.api_load_set_annotations, name='load_set_annotations'),  # loads annotations of an image
    url(r'^api/annotation/loadannotationtypes/$', views.api_load_annotation_types, name='load_annotation_types'),  # loads all active annotation types
    url(r'^api/annotation/loadsetannotationtypes/$', views.api_load_set_annotation_types, name='load_set_annotation_types'),  # loads annotations of an image
    url(r'^api/annotation/loadfilteredset/$', views.api_load_filtered_set_annotations, name='load_filtered_set_annotations'),  # loads filtered annotations of an image
    url(r'^api/annotation/loadone/$', views.api_load_annotation, name='load_annotation'),
    ...
    url(r'^api/annotation/update/$', views.api_update_annotation, name='update_annotations'),
]
