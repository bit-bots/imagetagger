...
TIME_ZONE = 'Asia/Shanghai'  # Timezone of your server
...
IMAGE_PATH = os.path.join(
    BASE_DIR, 'images')  # the absolute path to the folder with the imagesets
...
# defines if images get provided directly via nginx
# what generally improves imageset download performance
USE_NGINX_IMAGE_PROVISION = False

USE_IMPRINT = False
IMPRINT_NAME = ''
IMPRINT_URL = ''
UPLOAD_NOTICE = \
    'By uploading images to this tool you accept that' \
